...
import { Attempt, MicroSkill, SkillDomain, ErrorType } from '@/lib/types/prisma-types';
...
export class AdaptiveDifficultyEngine {
     ...
     * - Confusion detected + slow response (>6s)
     */
    static adjustDifficulty(
        ...
        // LEVEL UP conditions
        if (accuracy >= 80 && avgTime < 3 && !this.hasConsecutiveErrors(recentAttempts.slice(-5), 2)) {
