...
import { Shield, LogOut, FileText, Database, User, Gamepad2, Library } from 'lucide-react';
...
export default function AdminNavbar() {
    ...
    const navItems = [
        { href: '/admin/panel', icon: Shield, label: 'Dashboard' },
        { href: '/admin/documents', icon: FileText, label: 'Documents' },
        { href: '/admin/manage', icon: Database, label: 'Data Management' },
                ...
                <div className="flex items-center justify-between h-16">
                    ...
                    <Link href="/admin/panel">
                        ...
                        >
                            ...
                            <div>
                                <h1 className="text-white font-semibold text-xl tracking-tight">Admin Portal</h1>
                    ...
                    <div className="relative">
                        ...
                        >
                            ...
                            <motion.div
                                ...
                                className="w-8 h-8 bg-gradient-to-br from-emerald-400 to-teal-500 rounded-full flex items-center justify-center shadow-lg"
                            >
