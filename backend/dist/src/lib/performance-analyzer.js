...
class PerformanceAnalyzer {
     ...
     */
    calculateDomainPerformance(attempts) {
     ...
     */
    async analyzeWithAI(attempts, metrics, domainStats) {
...
4. Being encouraging and constructive`;
     ...
     */
    detectConfusionPatterns(attempts) {
        const patterns = {
            B_D_CONFUSION: 0,
            P_Q_CONFUSION: 0,
            M_N_CONFUSION: 0,
     ...
     */
    getFallbackInsights(metrics, confusionPatterns) {
        const strengths = [];
        const weaknesses = [];
...
exports.default = new PerformanceAnalyzer();
